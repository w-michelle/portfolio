...
const projectInfo = [
  ...
  },
  {
    ...
    stacks:
      "[Typescript/Zustand/Next.js/TailwindCSS/Prisma/PostgreSQL/AWS S3/NextAuth]",
    imgSrc: "/roam.png",
        ...
        >
          <div className="flex gap-4 flex-wrap md:flex-nowrap md:justify-between">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-xs w-[270px] text-neutral-400">
                {project.desc}
              </p>
              <Link
            ...
            <Link
              ...
              aria-label="view project"
              target="_blank"
              className="relative w-[300px] h-[200px] md:w-[380px] md:h-[250px] mr-5"
            >
              <Image
                src={project.imgSrc}
                fill
                alt="Project Image"
                className="object-cover object-top shadow-custom rounded-md"
              />
            </Link>
          </div>
        </div>
